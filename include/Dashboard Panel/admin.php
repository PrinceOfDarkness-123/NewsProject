...
$table_heading = "";
$table_data = "";
$fetch_database = "SELECT * FROM user WHERE type = 'Admin'";
...
if (mysqli_num_rows($results)>0){
    ...
    while($row = mysqli_fetch_assoc($results)){
         ...
         $table_data.="<tr>
             ...
             <td>$row[type]</td>
             <td>$row[status]</td>
             <td><a href='update-user.php?id=$row[id]' class='button-color btn btn-primary'><i class='fas fa-edit'></i></a>
             <a href='delete-admin.php?id=$row[id]' class='button-color btn btn-primary'><i class='fas fa-trash'></i></a></td>
         </tr>";
    }
}else{
